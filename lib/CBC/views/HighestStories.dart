...
class HighestStories extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        onRefresh: () async {
          ...
          controller.onRefreshFetchHighestDiscount();
        },
        child: Obx(() {
          if (!controller.isLoadingHighest.value) {
  ...
  stories() {
    return GridView.builder(
      controller: controller.scrollControllerHeighestDicont,
      ...
      itemCount: controller.highestList.length + 1,
      itemBuilder: (BuildContext context, int index) {
        if (controller.highestList.length <= index) {
          return Obx(
            () => controller.loadingPaginationHeightestDiscont.value
