...
class StorePage extends StatelessWidget {
              ...
              return SizedBox(
                ...
                child: ListView(
                  ...
                  children: [
                    Obx(() {
                      if (!builder.isLoadingItem.value) {
                        return (builder.store!.storeinfo.sliders.length > 0)
                            ? StoreSliders(context)
                            : placholder404();
                      } else {
                        return const ProgressCircularWidgetCustom();
                      }
                    }),
                    RefreshIndicator(
                      ...
                      child: Container(
                        ...
                        child: Container(
                          color: Colors.white,
                          height: heightAppBarCustom(context) * 0.73,
                          child: ListView(
                            shrinkWrap: true,
                            children: [
                              StoreLogo(),
                              ...
                              SizedBox(
                                height: heightAppBarCustom(context) * 0.4,
                                // height: controller.heightTabPage,
                                child: PagesTabs(),
                              )
                            ],
                          ),
    ...
    if (controller.store!.storeinfo.branches.isNotEmpty) {
      return ListView.builder(
        ...
        itemCount: controller
            .store!.storeinfo.branches.length, // عدد العناصر في القائمة
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    ...
                    offset:
                        const Offset(0, 5), // الإزاحة فقط في الاتجاه العمودي
                  ),
                ],
              ),
              child: Text(
                ...
                style: TextStyle(
                    fontSize: Get.width * 0.028, fontWeight: FontWeight.bold),
              ),
            ),
            trailing: Wrap(
              ...
              children: <Widget>[
                GestureDetector(
                  onTap: () {
                    controller.callPhone(
                        controller.store!.storeinfo.branches[index].phone);
                  },
                  child: Container(
                ...
                GestureDetector(
                  onTap: () {
                    controller.openurl(
                        controller.store!.storeinfo.branches[index].location);
                  },
                  child: Container(
                    padding: EdgeInsets.all(Get.width * 0.01),
                    decoration: BoxDecoration(
  ...
  imagesStore(list, text) {
    int desiredItemCount = list.length; // العدد المطلوب للصور
    int actualItemCount = list.length;
    // Get.width * 0.02;
    int placeholdersCount = desiredItemCount - actualItemCount;

    if (placeholdersCount < 0) {
      int newone = placeholdersCount * -1;
      print('\n');
      print('=========== wwwwww ================');
      print('The One is $newone');
      print('\n');
      placeholdersCount = newone;
    }
    print('\n');
    print('===========================');
    print('\n');
    print(
        'The Text is $text The Lenght placeholdersCount = $placeholdersCount And actualItemCount = $actualItemCount');
    ...
    if (controller.store!.storeinfo.discounts.isNotEmpty) {
      return ListView.builder(
        padding: EdgeInsetsDirectional.only(
            start: Get.width * 0.02, end: Get.width * 0.02),
        itemCount: controller
            .store!.storeinfo.discounts.length, // عدد العناصر في القائمة
        itemBuilder: (BuildContext context, int index) {
          return ListTile(
            title: Container(
              decoration: BoxDecoration(
            ...
            trailing: Container(
              ...
              child: Center(
                child: Text(
                  '${controller.store!.storeinfo.discounts[index].discount}',
                  style: TextStyle(
                      color: Colors.white,
                      fontWeight: FontWeight.bold,
  ...
  StoreLogo() {
    return Padding(
      padding: EdgeInsetsDirectional.only(start: Get.width * 0.05),
      child: Row(
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius:
                  BorderRadius.all(Radius.circular(Get.width * 0.025)),
          ...
          Column(
            ...
            children: [
              SizedBox(
                ...
                child: Text(
                  controller.store!.storeinfo.name,
              ...
              SizedBox(
                width: Get.width * 0.63,
                child: Text(
                  controller.store!.storeinfo.nameKur,
                  textAlign: TextAlign.start,
                  overflow: TextOverflow.ellipsis,
                  maxLines: 2,
                  style: TextStyle(
          ...
          SizedBox(
            ...
            child: Column(
              ...
              children: [
                ...
                //     children: [
                Text(
                  controller.store!.storeinfo.description,
                  style: TextStyle(
                      color: Colors.black,
                    ...
                    Row(
                      ...
                      children: [
                        GestureDetector(
                          onTap: () {
                            controller
                                .openurl(controller.store!.storeinfo.instagram);
                          },
                          child: Container(
                            padding: EdgeInsets.all(Get.width * 0.01),
                            decoration: BoxDecoration(
                        ...
                        GestureDetector(
                          onTap: () {
                            controller
                                .openurl(controller.store!.storeinfo.facebook);
                          },
                          child: Container(
                            padding: EdgeInsets.all(Get.width * 0.01),
                            decoration: BoxDecoration(
                    ...
                    Row(
                      ...
                      children: [
                        GestureDetector(
                          onTap: () {
                            controller.launchWhatsAppUri(
                                controller.store!.storeinfo.whatsapp);
                          },
                          child: Container(
                            padding: EdgeInsets.all(Get.width * 0.01),
                            decoration: BoxDecoration(
                        ...
                        GestureDetector(
                          onTap: () {
                            controller
                                .openurl(controller.store!.storeinfo.telegram);
                          },
                          child: Container(
                            padding: EdgeInsets.all(Get.width * 0.01),
                            decoration: BoxDecoration(
  ...
  StoreSliders(BuildContext context) {
    return Padding(
      padding:
          EdgeInsetsDirectional.only(top: heightAppBarCustom(context) * 0.02),
      child: SizedBox(
        height: heightAppBarCustom(context) * 0.25,
        child: Column(
          children: [
            CarouselSlider(
