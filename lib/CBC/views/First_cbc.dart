...
class First_cbc extends StatelessWidget {
  First_cbc({super.key});
  final AllCategoriesController Categorycontroller =
    ...
    return Scaffold(
      appBar: PreferredSize(
        preferredSize: Size.fromHeight(
            Get.width * 0.19), // Set preferred size for the app bar
        child: AppBar(
          flexibleSpace: TabBar(
              ...
              Tab(
                ...
                child: Container(
                  ...
                  padding: EdgeInsetsDirectional.only(
                      start: Get.height * 0.02, top: Get.height * 0.06),
            ...
            indicatorSize:
                TabBarIndicatorSize.tab, // Stretch the indicator to fit the tab
          ),
        ),
      ),
      body: Container(
