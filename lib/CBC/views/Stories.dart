...
class Stories extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text(
          '${controller.city_name} - ${controller.cate_name}',
          style: TextStyle(
              color: Colors.white,
                    ...
                    children: [
                      Obx(() {
                        if (!controller.isLoadingStories.value) {
                          return (controller.storiesList[0].ads.length > 0)
                              ? StoreSliders()
                              : placholder404();
                        } else {
        ...
        children: [
          Padding(
            padding: EdgeInsets.only(
                top: Get.width * 0.04, bottom: Get.width * 0.04),
            child: Text(
              '143'.tr,
              style: TextStyle(
  ...
  placholderSlider() {
    return Container(
      ...
      child: Center(
        ...
        child: const ProgressCircularWidgetCustom(),
      )),
    );
  }
  ...
  StoreSliders() {
    return Padding(
      padding: EdgeInsetsDirectional.only(top: Get.height * 0.02),
      child: SizedBox(
  ...
  stories() {
    return GridView.builder(
      ...
      itemBuilder: (BuildContext context, int index) {
        ...
        return StoreItem(
            Item.logo, Item.name, Item.id, Item.active, Item.discountCount);
      },
    );
  }
